...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private ColorStateList mAddButtonPlusColor;
    private ColorStateList mAddButtonColorNormal;
    ...
    private com.google.android.material.floatingactionbutton.FloatingActionButton mAddButton;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mLabelsMargin = (int) (attr.getDimension(R.styleable.FloatingActionsMenu_fab_labelMargin, getResources().getDimensionPixelSize(R.dimen.fab_labels_margin)));
        mButtonSpacing = (int) (attr.getDimension(R.styleable.FloatingActionsMenu_fab_buttonSpacing, getResources().getDimension(R.dimen.fab_actions_spacing)));
        mAddButtonPlusColor = attr.getColorStateList(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor);
        mAddButtonColorNormal = attr.getColorStateList(R.styleable.FloatingActionsMenu_fab_addButtonColorNormal);
    ...
    private void createAddButton(Context context) {
        mAddButton = new com.google.android.material.floatingactionbutton.FloatingActionButton(context);

        final RotatingDrawable rotatingDrawable = new RotatingDrawable(ContextCompat.getDrawable(context, R.drawable.ic_add));
        ...
        mAddButton.setImageTintList(mAddButtonPlusColor);
        mAddButton.setBackgroundTintList(mAddButtonColorNormal);
    ...
    public com.google.android.material.floatingactionbutton.FloatingActionButton getAddButton() {
        return mAddButton;
    }
    ...
    private void createLabels() {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            if (getChildAt(i) instanceof LabeledFloatingActionButton) {
                LabeledFloatingActionButton button = ((LabeledFloatingActionButton) getChildAt(i));

                String label = button.getLabel();

                if (button == mAddButton || label == null || button.getTag(R.id.fab_label) != null) {
                    continue;
                }

                TextView labelView = new TextView(context);
                labelView.setTextAppearance(getContext(), mLabelsStyle);
                labelView.setText(label);
                addView(labelView);

                button.setTag(R.id.fab_label, labelView);
            }
        }
    }
